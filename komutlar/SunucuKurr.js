...
await message.guild.channels.create('KATEGORİ | EĞLENCE', { type: "category" })  
  await message.guild.channels.create("💣︲bom", {type: "text", parent: message.guild.channels.cache.find(a => a.name === 'KATEGORİ | EĞLENCE').id})
   await message.guild.channels.create("🔢︲sayı-sayma", {type: "text", parent: message.guild.channels.cache.find(a => a.name === 'KATEGORİ | EĞLENCE').id})
   await message.guild.channels.create("💡︲kelime-türetme", {type: "text", parent: message.guild.channels.cache.find(a => a.name === 'KATEGORİ | EĞLENCE').id})
