...
exports.run = async (bot, message, args) => {
    ...
    if (args[0] == 'aç') {
        ...
        message.channel.send(`<:OnayPng:794135282093654047>  | **Sağ Tık Ban sistemi açıldı**`)

    }
    if (args[0] == 'kapat') {
        db.set(`koruma_${message.guild.id}`, 'kapali')
        message.channel.send(`<:OnayPng:794135282093654047>  | **Sağ Tık Ban sistemi kapatıldı**`)
